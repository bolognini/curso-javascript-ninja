...
*/
var championship = 'Estadual do Espírito Santo';
...
desafio.
*/
var teams = ['Estrela', 'Rio Branco', 'Desportiva', 'Vilavelhense', 'Itapemirim'];
...
function showTeamPosition(numero) {
    if(numero >= 0 && numero <= 4) {
        return "O time que está em " + (numero + 1) + "º lugar é o " + teams[numero];
    } else {
