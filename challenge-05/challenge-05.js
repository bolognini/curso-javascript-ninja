...
segundo parâmetro.
*/
function anotherFunction(arr = [x, y, z], n) {
    return arr[n];
}
...
*/
var thirdFunction = ['Nome', 25, 2.0, [1,2], function third() {thirdFunction[0]}];

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
console.log(anotherFunction([1, 2, thirdFunction], 2));
...
*/
console.log("O autor do livro Homo Ludens é " + book('Homo Ludens').autor);
